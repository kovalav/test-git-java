...
public class ShoppingCartInfoEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v17.ShoppingCartAddressEntity shipping_address;

    private test.api.wsdl.v17.ShoppingCartAddressEntity billing_address;

    private test.api.wsdl.v17.ShoppingCartItemEntity[] items;

    private test.api.wsdl.v17.ShoppingCartPaymentEntity payment;
    ...
    public ShoppingCartInfoEntity(
           ...
           test.api.wsdl.v17.ShoppingCartAddressEntity shipping_address,
           test.api.wsdl.v17.ShoppingCartAddressEntity billing_address,
           test.api.wsdl.v17.ShoppingCartItemEntity[] items,
           test.api.wsdl.v17.ShoppingCartPaymentEntity payment) {
     ...
     */
    public test.api.wsdl.v17.ShoppingCartAddressEntity getShipping_address() {
        return shipping_address;
    }
     ...
     */
    public void setShipping_address(test.api.wsdl.v17.ShoppingCartAddressEntity shipping_address) {
        this.shipping_address = shipping_address;
    }
     ...
     */
    public test.api.wsdl.v17.ShoppingCartAddressEntity getBilling_address() {
        return billing_address;
    }
     ...
     */
    public void setBilling_address(test.api.wsdl.v17.ShoppingCartAddressEntity billing_address) {
        this.billing_address = billing_address;
    }
     ...
     * @return items
     */
    public test.api.wsdl.v17.ShoppingCartItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(test.api.wsdl.v17.ShoppingCartItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return payment
     */
    public test.api.wsdl.v17.ShoppingCartPaymentEntity getPayment() {
        return payment;
    }
     ...
     * @param payment
     */
    public void setPayment(test.api.wsdl.v17.ShoppingCartPaymentEntity payment) {
        this.payment = payment;
    }
