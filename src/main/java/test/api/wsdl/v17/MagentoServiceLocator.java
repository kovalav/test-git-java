...
public class MagentoServiceLocator extends org.apache.axis.client.Service implements test.api.wsdl.v17.MagentoService {
    ...
    private java.lang.String Mage_Api_Model_Server_V2_HandlerPort_address = "http://local.duomo.gr/live/index.php/api/v2_soap/index/";
    ...
    public test.api.wsdl.v17.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort() throws javax.xml.rpc.ServiceException {
    ...
    public test.api.wsdl.v17.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.api.wsdl.v17.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new test.api.wsdl.v17.Mage_Api_Model_Server_V2_HandlerBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.api.wsdl.v17.Mage_Api_Model_Server_V2_HandlerPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                test.api.wsdl.v17.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new test.api.wsdl.v17.Mage_Api_Model_Server_V2_HandlerBindingStub(new java.net.URL(Mage_Api_Model_Server_V2_HandlerPort_address), this);
                _stub.setPortName(getMage_Api_Model_Server_V2_HandlerPortWSDDServiceName());
                return _stub;
            }
        }
