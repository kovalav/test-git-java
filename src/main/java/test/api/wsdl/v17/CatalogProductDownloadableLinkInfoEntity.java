...
public class CatalogProductDownloadableLinkInfoEntity  implements java.io.Serializable {
    private test.api.wsdl.v17.CatalogProductDownloadableLinkEntity[] links;

    private test.api.wsdl.v17.CatalogProductDownloadableLinkSampleEntity[] samples;

    public CatalogProductDownloadableLinkInfoEntity() {
    }

    public CatalogProductDownloadableLinkInfoEntity(
           test.api.wsdl.v17.CatalogProductDownloadableLinkEntity[] links,
           test.api.wsdl.v17.CatalogProductDownloadableLinkSampleEntity[] samples) {
           this.links = links;
     ...
     * @return links
     */
    public test.api.wsdl.v17.CatalogProductDownloadableLinkEntity[] getLinks() {
        return links;
    }
     ...
     * @param links
     */
    public void setLinks(test.api.wsdl.v17.CatalogProductDownloadableLinkEntity[] links) {
        this.links = links;
    }
     ...
     * @return samples
     */
    public test.api.wsdl.v17.CatalogProductDownloadableLinkSampleEntity[] getSamples() {
        return samples;
    }
     ...
     * @param samples
     */
    public void setSamples(test.api.wsdl.v17.CatalogProductDownloadableLinkSampleEntity[] samples) {
        this.samples = samples;
    }
