...
public class CatalogProductCustomOptionToAdd  implements java.io.Serializable {
    ...
    private test.api.wsdl.v17.CatalogProductCustomOptionAdditionalFieldsEntity[] additional_fields;
    ...
    public CatalogProductCustomOptionToAdd(
           ...
           test.api.wsdl.v17.CatalogProductCustomOptionAdditionalFieldsEntity[] additional_fields) {
           this.title = title;
           this.type = type;
     ...
     */
    public test.api.wsdl.v17.CatalogProductCustomOptionAdditionalFieldsEntity[] getAdditional_fields() {
        return additional_fields;
    }
     ...
     */
    public void setAdditional_fields(test.api.wsdl.v17.CatalogProductCustomOptionAdditionalFieldsEntity[] additional_fields) {
        this.additional_fields = additional_fields;
    }
