...
public class CatalogProductAttributeEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v17.AssociativeEntity[] additional_fields;

    private test.api.wsdl.v17.CatalogAttributeOptionEntity[] options;

    private test.api.wsdl.v17.CatalogProductAttributeFrontendLabelEntity[] frontend_label;
    ...
    public CatalogProductAttributeEntity(
           ...
           test.api.wsdl.v17.AssociativeEntity[] additional_fields,
           test.api.wsdl.v17.CatalogAttributeOptionEntity[] options,
           test.api.wsdl.v17.CatalogProductAttributeFrontendLabelEntity[] frontend_label) {
     ...
     */
    public test.api.wsdl.v17.AssociativeEntity[] getAdditional_fields() {
        return additional_fields;
    }
     ...
     */
    public void setAdditional_fields(test.api.wsdl.v17.AssociativeEntity[] additional_fields) {
        this.additional_fields = additional_fields;
    }
     ...
     * @return options
     */
    public test.api.wsdl.v17.CatalogAttributeOptionEntity[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(test.api.wsdl.v17.CatalogAttributeOptionEntity[] options) {
        this.options = options;
    }
     ...
     */
    public test.api.wsdl.v17.CatalogProductAttributeFrontendLabelEntity[] getFrontend_label() {
        return frontend_label;
    }
     ...
     */
    public void setFrontend_label(test.api.wsdl.v17.CatalogProductAttributeFrontendLabelEntity[] frontend_label) {
        this.frontend_label = frontend_label;
    }
