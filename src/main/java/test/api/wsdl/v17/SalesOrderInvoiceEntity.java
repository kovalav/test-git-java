...
public class SalesOrderInvoiceEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v17.SalesOrderInvoiceItemEntity[] items;

    private test.api.wsdl.v17.SalesOrderInvoiceCommentEntity[] comments;
    ...
    public SalesOrderInvoiceEntity(
           ...
           test.api.wsdl.v17.SalesOrderInvoiceItemEntity[] items,
           test.api.wsdl.v17.SalesOrderInvoiceCommentEntity[] comments) {
     ...
     * @return items
     */
    public test.api.wsdl.v17.SalesOrderInvoiceItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(test.api.wsdl.v17.SalesOrderInvoiceItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public test.api.wsdl.v17.SalesOrderInvoiceCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(test.api.wsdl.v17.SalesOrderInvoiceCommentEntity[] comments) {
        this.comments = comments;
    }
