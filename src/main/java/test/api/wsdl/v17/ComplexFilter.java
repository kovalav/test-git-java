...
public class ComplexFilter  implements java.io.Serializable {
    ...
    private test.api.wsdl.v17.AssociativeEntity value;
    ...
    public ComplexFilter(
           ...
           test.api.wsdl.v17.AssociativeEntity value) {
           this.key = key;
           this.value = value;
    }
     ...
     * @return value
     */
    public test.api.wsdl.v17.AssociativeEntity getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(test.api.wsdl.v17.AssociativeEntity value) {
        this.value = value;
    }
