...
public class CatalogProductDownloadableLinkEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v17.CatalogProductDownloadableLinkFileInfoEntity[] file_save;

    private test.api.wsdl.v17.CatalogProductDownloadableLinkFileInfoEntity[] sample_file_save;
    ...
    public CatalogProductDownloadableLinkEntity(
           ...
           int sort_order,
           test.api.wsdl.v17.CatalogProductDownloadableLinkFileInfoEntity[] file_save,
           test.api.wsdl.v17.CatalogProductDownloadableLinkFileInfoEntity[] sample_file_save) {
     ...
     * @return file_save
     */
    public test.api.wsdl.v17.CatalogProductDownloadableLinkFileInfoEntity[] getFile_save() {
        return file_save;
    }
     ...
     * @param file_save
     */
    public void setFile_save(test.api.wsdl.v17.CatalogProductDownloadableLinkFileInfoEntity[] file_save) {
        this.file_save = file_save;
    }
     ...
     */
    public test.api.wsdl.v17.CatalogProductDownloadableLinkFileInfoEntity[] getSample_file_save() {
        return sample_file_save;
    }
     ...
     */
    public void setSample_file_save(test.api.wsdl.v17.CatalogProductDownloadableLinkFileInfoEntity[] sample_file_save) {
        this.sample_file_save = sample_file_save;
    }
