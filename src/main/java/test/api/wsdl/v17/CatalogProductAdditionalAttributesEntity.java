...
public class CatalogProductAdditionalAttributesEntity  implements java.io.Serializable {
    private test.api.wsdl.v17.AssociativeMultiEntity[] multi_data;

    private test.api.wsdl.v17.AssociativeEntity[] single_data;

    public CatalogProductAdditionalAttributesEntity() {
    }

    public CatalogProductAdditionalAttributesEntity(
           test.api.wsdl.v17.AssociativeMultiEntity[] multi_data,
           test.api.wsdl.v17.AssociativeEntity[] single_data) {
     ...
     * @return multi_data
     */
    public test.api.wsdl.v17.AssociativeMultiEntity[] getMulti_data() {
        return multi_data;
    }
     ...
     * @param multi_data
     */
    public void setMulti_data(test.api.wsdl.v17.AssociativeMultiEntity[] multi_data) {
        this.multi_data = multi_data;
    }
     ...
     * @return single_data
     */
    public test.api.wsdl.v17.AssociativeEntity[] getSingle_data() {
        return single_data;
    }
     ...
     * @param single_data
     */
    public void setSingle_data(test.api.wsdl.v17.AssociativeEntity[] single_data) {
        this.single_data = single_data;
    }
