...
public class SalesOrderShipmentEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v17.SalesOrderShipmentItemEntity[] items;

    private test.api.wsdl.v17.SalesOrderShipmentTrackEntity[] tracks;

    private test.api.wsdl.v17.SalesOrderShipmentCommentEntity[] comments;
    ...
    public SalesOrderShipmentEntity(
           ...
           test.api.wsdl.v17.SalesOrderShipmentItemEntity[] items,
           test.api.wsdl.v17.SalesOrderShipmentTrackEntity[] tracks,
           test.api.wsdl.v17.SalesOrderShipmentCommentEntity[] comments) {
     ...
     * @return items
     */
    public test.api.wsdl.v17.SalesOrderShipmentItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(test.api.wsdl.v17.SalesOrderShipmentItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return tracks
     */
    public test.api.wsdl.v17.SalesOrderShipmentTrackEntity[] getTracks() {
        return tracks;
    }
     ...
     * @param tracks
     */
    public void setTracks(test.api.wsdl.v17.SalesOrderShipmentTrackEntity[] tracks) {
        this.tracks = tracks;
    }
     ...
     * @return comments
     */
    public test.api.wsdl.v17.SalesOrderShipmentCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(test.api.wsdl.v17.SalesOrderShipmentCommentEntity[] comments) {
        this.comments = comments;
    }
