...
public class SalesOrderCreditmemoData  implements java.io.Serializable {
    private test.api.wsdl.v17.OrderItemIdQty[] qtys;
    ...
    public SalesOrderCreditmemoData(
           test.api.wsdl.v17.OrderItemIdQty[] qtys,
     ...
     * @return qtys
     */
    public test.api.wsdl.v17.OrderItemIdQty[] getQtys() {
        return qtys;
    }
     ...
     * @param qtys
     */
    public void setQtys(test.api.wsdl.v17.OrderItemIdQty[] qtys) {
        this.qtys = qtys;
    }
