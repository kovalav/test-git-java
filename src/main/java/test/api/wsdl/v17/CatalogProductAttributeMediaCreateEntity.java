...
public class CatalogProductAttributeMediaCreateEntity  implements java.io.Serializable {
    private test.api.wsdl.v17.CatalogProductImageFileEntity file;
    ...
    public CatalogProductAttributeMediaCreateEntity(
           test.api.wsdl.v17.CatalogProductImageFileEntity file,
     ...
     * @return file
     */
    public test.api.wsdl.v17.CatalogProductImageFileEntity getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(test.api.wsdl.v17.CatalogProductImageFileEntity file) {
        this.file = file;
    }
