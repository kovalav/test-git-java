...
public class Filters  implements java.io.Serializable {
    private test.api.wsdl.v17.AssociativeEntity[] filter;

    private test.api.wsdl.v17.ComplexFilter[] complex_filter;

    public Filters() {
    }

    public Filters(
           test.api.wsdl.v17.AssociativeEntity[] filter,
           test.api.wsdl.v17.ComplexFilter[] complex_filter) {
           this.filter = filter;
     ...
     * @return filter
     */
    public test.api.wsdl.v17.AssociativeEntity[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(test.api.wsdl.v17.AssociativeEntity[] filter) {
        this.filter = filter;
    }
     ...
     */
    public test.api.wsdl.v17.ComplexFilter[] getComplex_filter() {
        return complex_filter;
    }
     ...
     */
    public void setComplex_filter(test.api.wsdl.v17.ComplexFilter[] complex_filter) {
        this.complex_filter = complex_filter;
    }
