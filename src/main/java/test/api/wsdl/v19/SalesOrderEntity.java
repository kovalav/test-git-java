...
public class SalesOrderEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v19.SalesOrderAddressEntity shipping_address;

    private test.api.wsdl.v19.SalesOrderAddressEntity billing_address;

    private test.api.wsdl.v19.SalesOrderItemEntity[] items;

    private test.api.wsdl.v19.SalesOrderPaymentEntity payment;

    private test.api.wsdl.v19.SalesOrderStatusHistoryEntity[] status_history;
    ...
    public SalesOrderEntity(
           ...
           test.api.wsdl.v19.SalesOrderAddressEntity shipping_address,
           test.api.wsdl.v19.SalesOrderAddressEntity billing_address,
           test.api.wsdl.v19.SalesOrderItemEntity[] items,
           test.api.wsdl.v19.SalesOrderPaymentEntity payment,
           test.api.wsdl.v19.SalesOrderStatusHistoryEntity[] status_history) {
     ...
     */
    public test.api.wsdl.v19.SalesOrderAddressEntity getShipping_address() {
        return shipping_address;
    }
     ...
     */
    public void setShipping_address(test.api.wsdl.v19.SalesOrderAddressEntity shipping_address) {
        this.shipping_address = shipping_address;
    }
     ...
     */
    public test.api.wsdl.v19.SalesOrderAddressEntity getBilling_address() {
        return billing_address;
    }
     ...
     */
    public void setBilling_address(test.api.wsdl.v19.SalesOrderAddressEntity billing_address) {
        this.billing_address = billing_address;
    }
     ...
     * @return items
     */
    public test.api.wsdl.v19.SalesOrderItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(test.api.wsdl.v19.SalesOrderItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return payment
     */
    public test.api.wsdl.v19.SalesOrderPaymentEntity getPayment() {
        return payment;
    }
     ...
     * @param payment
     */
    public void setPayment(test.api.wsdl.v19.SalesOrderPaymentEntity payment) {
        this.payment = payment;
    }
     ...
     */
    public test.api.wsdl.v19.SalesOrderStatusHistoryEntity[] getStatus_history() {
        return status_history;
    }
     ...
     */
    public void setStatus_history(test.api.wsdl.v19.SalesOrderStatusHistoryEntity[] status_history) {
        this.status_history = status_history;
    }
