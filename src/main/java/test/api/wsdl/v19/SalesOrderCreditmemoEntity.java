...
public class SalesOrderCreditmemoEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v19.SalesOrderCreditmemoItemEntity[] items;

    private test.api.wsdl.v19.SalesOrderCreditmemoCommentEntity[] comments;
    ...
    public SalesOrderCreditmemoEntity(
           ...
           test.api.wsdl.v19.SalesOrderCreditmemoItemEntity[] items,
           test.api.wsdl.v19.SalesOrderCreditmemoCommentEntity[] comments) {
     ...
     * @return items
     */
    public test.api.wsdl.v19.SalesOrderCreditmemoItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(test.api.wsdl.v19.SalesOrderCreditmemoItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public test.api.wsdl.v19.SalesOrderCreditmemoCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(test.api.wsdl.v19.SalesOrderCreditmemoCommentEntity[] comments) {
        this.comments = comments;
    }
