...
public class ApiEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v19.ApiMethodEntity[] methods;
    ...
    public ApiEntity(
           ...
           test.api.wsdl.v19.ApiMethodEntity[] methods) {
           this.title = title;
           this.name = name;
     ...
     * @return methods
     */
    public test.api.wsdl.v19.ApiMethodEntity[] getMethods() {
        return methods;
    }
     ...
     * @param methods
     */
    public void setMethods(test.api.wsdl.v19.ApiMethodEntity[] methods) {
        this.methods = methods;
    }
