...
public class CatalogProductCustomOptionToUpdate  implements java.io.Serializable {
    ...
    private test.api.wsdl.v19.CatalogProductCustomOptionAdditionalFieldsEntity[] additional_fields;
    ...
    public CatalogProductCustomOptionToUpdate(
           ...
           test.api.wsdl.v19.CatalogProductCustomOptionAdditionalFieldsEntity[] additional_fields) {
           this.title = title;
           this.type = type;
     ...
     */
    public test.api.wsdl.v19.CatalogProductCustomOptionAdditionalFieldsEntity[] getAdditional_fields() {
        return additional_fields;
    }
     ...
     */
    public void setAdditional_fields(test.api.wsdl.v19.CatalogProductCustomOptionAdditionalFieldsEntity[] additional_fields) {
        this.additional_fields = additional_fields;
    }
