...
public class CatalogProductAttributeOptionEntityToAdd  implements java.io.Serializable {
    private test.api.wsdl.v19.CatalogProductAttributeOptionLabelEntity[] label;
    ...
    public CatalogProductAttributeOptionEntityToAdd(
           test.api.wsdl.v19.CatalogProductAttributeOptionLabelEntity[] label,
           int order,
           int is_default) {
           this.label = label;
           this.order = order;
     ...
     * @return label
     */
    public test.api.wsdl.v19.CatalogProductAttributeOptionLabelEntity[] getLabel() {
        return label;
    }
     ...
     * @param label
     */
    public void setLabel(test.api.wsdl.v19.CatalogProductAttributeOptionLabelEntity[] label) {
        this.label = label;
    }
