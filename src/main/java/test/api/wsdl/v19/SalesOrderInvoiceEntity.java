...
public class SalesOrderInvoiceEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v19.SalesOrderInvoiceItemEntity[] items;

    private test.api.wsdl.v19.SalesOrderInvoiceCommentEntity[] comments;
    ...
    public SalesOrderInvoiceEntity(
           ...
           test.api.wsdl.v19.SalesOrderInvoiceItemEntity[] items,
           test.api.wsdl.v19.SalesOrderInvoiceCommentEntity[] comments) {
     ...
     * @return items
     */
    public test.api.wsdl.v19.SalesOrderInvoiceItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(test.api.wsdl.v19.SalesOrderInvoiceItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public test.api.wsdl.v19.SalesOrderInvoiceCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(test.api.wsdl.v19.SalesOrderInvoiceCommentEntity[] comments) {
        this.comments = comments;
    }
