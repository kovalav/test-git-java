...
public class ShoppingCartProductEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v19.AssociativeEntity[] options;

    private test.api.wsdl.v19.AssociativeEntity[] bundle_option;

    private test.api.wsdl.v19.AssociativeEntity[] bundle_option_qty;
    ...
    public ShoppingCartProductEntity(
           ...
           test.api.wsdl.v19.AssociativeEntity[] options,
           test.api.wsdl.v19.AssociativeEntity[] bundle_option,
           test.api.wsdl.v19.AssociativeEntity[] bundle_option_qty,
     ...
     * @return options
     */
    public test.api.wsdl.v19.AssociativeEntity[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(test.api.wsdl.v19.AssociativeEntity[] options) {
        this.options = options;
    }
     ...
     */
    public test.api.wsdl.v19.AssociativeEntity[] getBundle_option() {
        return bundle_option;
    }
     ...
     * @param bundle_option
     */
    public void setBundle_option(test.api.wsdl.v19.AssociativeEntity[] bundle_option) {
        this.bundle_option = bundle_option;
    }
     ...
     */
    public test.api.wsdl.v19.AssociativeEntity[] getBundle_option_qty() {
        return bundle_option_qty;
    }
     ...
     */
    public void setBundle_option_qty(test.api.wsdl.v19.AssociativeEntity[] bundle_option_qty) {
        this.bundle_option_qty = bundle_option_qty;
    }
