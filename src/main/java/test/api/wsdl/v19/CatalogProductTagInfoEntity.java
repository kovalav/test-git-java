...
public class CatalogProductTagInfoEntity  implements java.io.Serializable {
    ...
    private test.api.wsdl.v19.AssociativeEntity[] products;
    ...
    public CatalogProductTagInfoEntity(
           ...
           test.api.wsdl.v19.AssociativeEntity[] products) {
           this.name = name;
           this.status = status;
     ...
     * @return products
     */
    public test.api.wsdl.v19.AssociativeEntity[] getProducts() {
        return products;
    }
     ...
     * @param products
     */
    public void setProducts(test.api.wsdl.v19.AssociativeEntity[] products) {
        this.products = products;
    }
