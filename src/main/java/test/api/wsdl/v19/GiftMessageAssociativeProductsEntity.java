...
public class GiftMessageAssociativeProductsEntity  implements java.io.Serializable {
    private test.api.wsdl.v19.ShoppingCartProductEntity product;

    private test.api.wsdl.v19.GiftMessageEntity message;

    public GiftMessageAssociativeProductsEntity() {
    }

    public GiftMessageAssociativeProductsEntity(
           test.api.wsdl.v19.ShoppingCartProductEntity product,
           test.api.wsdl.v19.GiftMessageEntity message) {
     ...
     * @return product
     */
    public test.api.wsdl.v19.ShoppingCartProductEntity getProduct() {
        return product;
    }
     ...
     * @param product
     */
    public void setProduct(test.api.wsdl.v19.ShoppingCartProductEntity product) {
        this.product = product;
    }
     ...
     * @return message
     */
    public test.api.wsdl.v19.GiftMessageEntity getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(test.api.wsdl.v19.GiftMessageEntity message) {
        this.message = message;
    }
